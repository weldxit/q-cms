...
const Index = () => {
    ...
    const postStory = async (e) => {
        e.preventDefault()
        axios.put(`https://cms-qdb.onrender.com/posts/${id}/update_posts`, {
            title: ptitle,
            slug: pslug,
            cat_id: pcate,
            author_id: pauth,
                            ...
                            <div>
                                <form onSubmit={postStory} className={style.form}>
                                    <div className={style.fdiv}>
                                        ...
                                        <input className={style.input} type="text" onChange={e => slugify(e.target.value)} defaultValue={post.title} />
                                    </div>
                                    <div className={style.fdiv}>
                                    ...
                                    <div className={style.fdiv1}>
                                        ...
                                        <div className={style.fdiv2}>
                                            ...
                                            <input type="text" className={style.input} onChange={e => setYt(e.target.value)} defaultValue={post.yt_link} />
                                        </div>
                                    </div>
                                    <div className={style.fdiv1}>
                                        <div className={style.fdiv2}>
                                        ...
                                        <div className={style.fdiv2}>
                                            ...
                                            <input className={style.input} type="date" onChange={uploadToS3P} defaultValue={post.post_date} />
                                        </div>
                                    </div>
                                    ...
                                    <div className={style.fdiv}>
                                        ...
                                        <Editor change={description} value={post.post_desc} />
                                    </div>
